...
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', "https://t.me/Shazam_bot_support")
VERIFY2_URL = environ.get('VERIFY2_URL', "ziplinker.net")
VERIFY2_API = environ.get('VERIFY2_API', "c01130685079db559867f38513562652c11bc6dc")
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'ziplinker.net')
SHORTLINK_API = environ.get('SHORTLINK_API', 'c01130685079db559867f38513562652c11bc6dc')
IS_SHORTLINK = is_enabled((environ.get('IS_SHORTLINK', 'True')), True)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/movie_adda_request_group')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/moviexadda_update')
